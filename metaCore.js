            ...
            "feeders": {
              ...
              "Manage":{"label":"Manage the Meta", 
                "commandset": [
                  ...
                  {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"Show LogLevel", "itemlabel":"Show current loglevels", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                    "itemaction":"SHOWLOGLEVEL","itemUI" : "reload"},
                  {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"Adjust LogLevel", "itemlabel":"Change loglevel on-flight", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                  "evalnext":[{"test":true, "then":"MODULES", "or":""}]
                },
              ...
              "MODULES":{"label":"Set LogLevel for a module", 
                "commandset": [
                    {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"ALL", "itemlabel":"Loglevel for ALL", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                    "evalnext":[{"test":true, "then":"LOGLEVEL", "or":""}],"evalwrite":[{"variable":"MODULE","value":"ALL"}]},
                    {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"meta", "itemlabel":"Loglevel for META", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                    "evalnext":[{"test":true, "then":"LOGLEVEL", "or":""}],"evalwrite":[{"variable":"MODULE","value":"meta"}]},
                    {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"directoryHelper", "itemlabel":"Loglevel for directoryHelper", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                      "evalnext":[{"test":true, "then":"LOGLEVEL", "or":""}],"evalwrite":[{"variable":"MODULE","value":"directoryHelper"}]},
                      {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"imageHelper", "itemlabel":"Loglevel for imageHelper", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                      "evalnext":[{"test":true, "then":"LOGLEVEL", "or":""}],"evalwrite":[{"variable":"MODULE","value":"imageHelper"}]},
                      {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"labelHelper", "itemlabel":"Loglevel for labelHelper", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                      "evalnext":[{"test":true, "then":"LOGLEVEL", "or":""}],"evalwrite":[{"variable":"MODULE","value":"labelHelper"}]},
                    {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"metaController", "itemlabel":"Loglevel for MetaController", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                      "evalnext":[{"test":true, "then":"LOGLEVEL", "or":""}],"evalwrite":[{"variable":"MODULE","value":"metaController"}]},
                      {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"metaMessage", "itemlabel":"Loglevel for metaMessage", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                      "evalnext":[{"test":true, "then":"LOGLEVEL", "or":""}],"evalwrite":[{"variable":"MODULE","value":"metaMessage"}]},
                    {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"processingManager", "itemlabel":"Loglevel for processingManager", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                      "evalnext":[{"test":true, "then":"LOGLEVEL", "or":""}],"evalwrite":[{"variable":"MODULE","value":"processingManager"}]},
                    {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"sensorHelper", "itemlabel":"Loglevel for sensorHelper", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                      "evalnext":[{"test":true, "then":"LOGLEVEL", "or":""}],"evalwrite":[{"variable":"MODULE","value":"sensorHelper"}]},
                    {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"sliderHelper", "itemlabel":"Loglevel for sliderHelper", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                      "evalnext":[{"test":true, "then":"LOGLEVEL", "or":""}],"evalwrite":[{"variable":"MODULE","value":"sliderHelper"}]},
                    {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"switchHelper", "itemlabel":"Loglevel for switchHelper", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                      "evalnext":[{"test":true, "then":"LOGLEVEL", "or":""}],"evalwrite":[{"variable":"MODULE","value":"switchHelper"}]},
                      {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"variablesVault", "itemlabel":"Loglevel for variablesVault", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                      "evalnext":[{"test":true, "then":"LOGLEVEL", "or":""}],"evalwrite":[{"variable":"MODULE","value":"variablesVault"}]}
                    ]
              },
              "LOGLEVEL":{"label":"Set LogLevel", 
                "commandset": [
                    {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"REMOVE", "itemlabel":"REMOVE Loglevel $MODULE", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                    "itemaction":"__LOGLEVEL","itemUI" : "goBack","evalwrite":[{"variable":"LOGLEVEL","value":""}]},
                    {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"QUIET", "itemlabel":"Loglevel QUIET for $MODULE", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                    "itemaction":"__LOGLEVEL","itemUI" : "goBack","evalwrite":[{"variable":"LOGLEVEL","value":"QUIET"}]},
                    {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"WARNING", "itemlabel":"Loglevel Warning for $MODULE", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                    "itemaction":"__LOGLEVEL","itemUI" : "goBack","evalwrite":[{"variable":"LOGLEVEL","value":"WARNING"}]},
                    {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"INFO", "itemlabel":"Loglevel INFO for $MODULE", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                    "itemaction":"__LOGLEVEL","itemUI" : "goBack","evalwrite":[{"variable":"LOGLEVEL","value":"INFO"}]},
                    {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"VERBOSE", "itemlabel":"Loglevel VERBOSE for $MODULE", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
                    "itemaction":"__LOGLEVEL","itemUI" : "goBack","evalwrite":[{"variable":"LOGLEVEL","value":"VERBOSE"}]},
                    {"type":"static", "command":"{\"\":true}", "queryresult":"$.", "itemname":"DEBUG", "itemlabel":"Loglevel DEBUG for $MODULE", "itemimage":"https://raw.githubusercontent.com/jac459/meta-core/main/pics/meta.jpg",
              ...
              "SHOWLOGLEVEL":{"label":"", "commandset": [{"type":"loglevel", "command":"SHOWLOGLEVEL"}]},
              
  
              "__LOGLEVEL":{"label":"", "commandset": [{"type":"loglevel", "command":"$LOGLEVEL,$MODULE"}]},
